...
local function createRandomWalkingCloud()
	...
	timer.performWithDelay(1000,createRandomWalkingCloud)
end
...
physics.addBody(heroAngel,physicsData:get("char_walk_1"))
...
local function checkGameOver()
	...
	if (heroAngel.y>display.contentHeight) then
		...
		local restartButton = ui.newButton{
			default = "restart_inactive.png",
			over = "restart_active.png",
